...
<html lang="en">
  ...
  <body>
    <?php require('header.php'); showHeader(4); ?>
    <div class="container">
            ...
            <div class="row">
              <div class="card flex-md-row mb-4 box-shadow h-md-350">
                <div class="card-body d-flex flex-column align-items-start text-justify">
                  <strong class="d-inline-block mb-2 text-primary">Call For Posters </strong>
                  <p>
                    <small> Poster presentations offer researchers an excellent forum to present and discuss preliminary research findings along with novel and original ideas. Posters also provide an opportunity for authors to present advances in existing pool of knowledge in key areas i.e. engineering, science and technology. Presenting a poster is a great way to get feedback simultaneously while having one to one interaction with peers.<br>

                      Posters provide authors and participants with an opportunity to connect with each other and to engage in discussions about the new frontiers of research and innovations. Poster presentations will be an integral part of the IWEPE-2019, with an interactive discussion between presenters and other distinguished delegates.<br>
